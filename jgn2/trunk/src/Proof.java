...
public class Proof
{
   ...
   public static final void main(String[] args) throws Exception
   {
      ...
      for (int i = 0; i < runs; i++)
      {
         ...
         if (print)
         {
            System.out.println("  reflection average speed:\tserialize=" + (t0 / loops) + "ns (" + 1000000L / (t0 / loops) + "k/s)\tdeserialize=" + (t1 / loops) + "ns (" + 1000000L / (t1 / loops) + "k/s)");
         }
      }
   }
   ...
   private static Prop[] investigate(Class clazz) throws Exception
   {
      ...
      for (Method method : methods)
      {
         ...
         if (parameters.length != 1 || parameters[0] != returnType)
            continue;
         ...
         System.out.println("found getter/setter: " + type.getSimpleName() + " " + property);
         props.add(prop);
      }
   ...
   private static final Prop createPropForType(String name, Class type, Method getter, Method setter)
   {
      if (type.isArray())
      {
         if (type == boolean[].class)
            return new BooleanArrayProp(name, getter, setter);
         if (type == byte[].class)
            return new ByteArrayProp(name, getter, setter);
         if (type == char[].class)
            return new CharArrayProp(name, getter, setter);
         if (type == short[].class)
            return new ShortArrayProp(name, getter, setter);
         if (type == int[].class)
            return new IntArrayProp(name, getter, setter);
         if (type == long[].class)
            return new LongArrayProp(name, getter, setter);
         if (type == float[].class)
            return new FloatArrayProp(name, getter, setter);
         if (type == double[].class)
            return new DoubleArrayProp(name, getter, setter);
      }
      else
      {
         if (type == boolean.class)
            return new BooleanProp(name, getter, setter);
         if (type == byte.class)
            return new ByteProp(name, getter, setter);
         if (type == char.class)
            return new CharProp(name, getter, setter);
         if (type == short.class)
            return new ShortProp(name, getter, setter);
         if (type == int.class)
            return new IntProp(name, getter, setter);
         if (type == long.class)
            return new LongProp(name, getter, setter);
         if (type == float.class)
            return new FloatProp(name, getter, setter);
         if (type == double.class)
            return new DoubleProp(name, getter, setter);
      }

      if (type == String.class)
         return new StringProp(name, getter, setter);
   ...
   private static class BooleanProp implements Prop
   {
      ...
      public void get(Message message, ByteBuffer bb) throws Exception
      {
         bb.put(((Boolean) getter.invoke(message, EMPTY_ARRAY)).booleanValue() ? (byte) 1 : (byte) 0);
      }
   ...
   private static class CharProp implements Prop
   {
      ...
      public void get(Message message, ByteBuffer bb) throws Exception
      {
         bb.putChar(((Character) getter.invoke(message, EMPTY_ARRAY)).charValue());
      }
   ...
   private static class ShortProp implements Prop
   {
      ...
      public void get(Message message, ByteBuffer bb) throws Exception
      {
         bb.putShort(((Short) getter.invoke(message, EMPTY_ARRAY)).shortValue());
      }
   ...
   private static class IntProp implements Prop
   {
      ...
      public void get(Message message, ByteBuffer bb) throws Exception
      {
         bb.putInt(((Integer) getter.invoke(message, EMPTY_ARRAY)).intValue());
      }
   ...
   private static class LongProp implements Prop
   {
      ...
      public void get(Message message, ByteBuffer bb) throws Exception
      {
         bb.putLong(((Long) getter.invoke(message, EMPTY_ARRAY)).longValue());
      }
   ...
   private static class FloatProp implements Prop
   {
      ...
      public void get(Message message, ByteBuffer bb) throws Exception
      {
         bb.putFloat(((Float) getter.invoke(message, EMPTY_ARRAY)).floatValue());
      }
   ...
   private static class DoubleProp implements Prop
   {
      ...
      public void get(Message message, ByteBuffer bb) throws Exception
      {
         bb.putDouble(((Double) getter.invoke(message, EMPTY_ARRAY)).doubleValue());
      }
